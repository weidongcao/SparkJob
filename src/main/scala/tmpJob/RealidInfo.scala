...
object RealidInfo {
  ...
  //Hbase信息
  val TABLE_NAME = "H_REG_REALID_INFO_TMP";
  val CF = "REALID_INFO";
  ...
  //val zkHost = "dn1.hadoop.com:2181,dn2.hadoop.com:2181,dn3.hadoop.com:2181,nn1.hadoop.com:2181,nn2.hadoop.com:2181"
  ...
  def main(args: Array[String]): Unit = {
    ...
    hconf.set("hbase.zookeeper.master", "dn2:60000")
    ...
    val sconf = new SparkConf().setAppName("indexRealidInfo_tmp")
  ...
  def transFormDocs(result: Result, sDoc: SolrInputDocument) {
    ...
    sDoc.addField("SEX", etl_field(Bytes.toString(result.getValue(CF.getBytes, "SEX".getBytes))));
    sDoc.addField("BIRTHDAY", etl_field(Bytes.toString(result.getValue(CF.getBytes, "BIRTHDAY".getBytes))));
    sDoc.addField("PEOPLE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "PEOPLE".getBytes))));
    sDoc.addField("COUNTRY", etl_field(Bytes.toString(result.getValue(CF.getBytes, "COUNTRY".getBytes))));
    sDoc.addField("ORG_NAME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "ORG_NAME".getBytes))));
    sDoc.addField("REMARK", etl_field(Bytes.toString(result.getValue(CF.getBytes, "REMARK".getBytes))));
    sDoc.addField("LAST_LOGINTIME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "LAST_LOGINTIME".getBytes))));
    sDoc.addField("LAST_SERVICE_CODE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "LAST_SERVICE_CODE".getBytes))));
    sDoc.addField("USE_NUMS", etl_field(Bytes.toString(result.getValue(CF.getBytes, "USE_NUMS".getBytes))));
    sDoc.addField("FIRST_LOGINTIME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "FIRST_LOGINTIME".getBytes))));
    sDoc.addField("FIRST_SERVICE_CODE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "FIRST_SERVICE_CODE".getBytes))));
    sDoc.addField("FIRST_ROOM_ID", etl_field(Bytes.toString(result.getValue(CF.getBytes, "FIRST_ROOM_ID".getBytes))));
    sDoc.addField("LAST_ROOM_ID", etl_field(Bytes.toString(result.getValue(CF.getBytes, "LAST_ROOM_ID".getBytes))));
    sDoc.addField("QQ_NUMS", etl_field(Bytes.toString(result.getValue(CF.getBytes, "QQ_NUMS".getBytes))));
    sDoc.addField("USER_ADDRESS", etl_field(Bytes.toString(result.getValue(CF.getBytes, "USER_ADDRESS".getBytes))));
    sDoc.addField("USER_PHONE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "USER_PHONE".getBytes))));
    sDoc.addField("ID_EXPIRETIME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "ID_EXPIRETIME".getBytes))));
