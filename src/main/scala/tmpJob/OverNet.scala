...
object OverNet {
  ...
  //Hbase信息
  val TABLE_NAME = "H_REG_CONTENT_OVERNET_TMP";
  val CF = "CONTENT_OVERNET";
  ...
  def main(args: Array[String]): Unit = {
    ...
    //初始化SparkConf
    val sconf = new SparkConf().setAppName("indexOverNet_tmp")
//    val sconf = new SparkConf().setAppName("indexOverNet")
