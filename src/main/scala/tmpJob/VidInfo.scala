...
object VidInfo {
  ...
  //Hbase信息
  val TABLE_NAME = "H_REG_VID_INFO_TMP";
  val CF = "VID_INFO";
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sconf = new SparkConf().setAppName("indexVidInfo")
  ...
  def transFormDocs(result: Result, sDoc: SolrInputDocument) {
    ...
    sDoc.addField("NICK_NAME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "NICK_NAME".getBytes))));
    ...
    sDoc.addField("REALID_NUMS", etl_field(Bytes.toString(result.getValue(CF.getBytes, "REALID_NUMS".getBytes))));
