...
object Game {
  ...
  //Hbase信息
  val TABLE_NAME = "H_REG_CONTENT_GAME_TMP";
  val CF = "CONTENT_GAME";
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sconf = new SparkConf().setAppName("indexGame_tmp")
  ...
  def transFormDocs(result: Result, sDoc: SolrInputDocument) {
    ...
    sDoc.addField("GAMENAME", etl_field(Bytes.toString(result.getValue(CF.getBytes, "GAMENAME".getBytes))));
    ...
    sDoc.addField("POSTING_ID", etl_field(Bytes.toString(result.getValue(CF.getBytes, "POSTING_ID".getBytes))));
    sDoc.addField("TITLE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "TITLE".getBytes))));
    sDoc.addField("AUTHOR", etl_field(Bytes.toString(result.getValue(CF.getBytes, "AUTHOR".getBytes))));
    sDoc.addField("SOURCE", etl_field(Bytes.toString(result.getValue(CF.getBytes, "SOURCE".getBytes))));
